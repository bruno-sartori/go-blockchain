...
// converts a hex-encoded string to an account and validates the
...
// validates the account starts with a 0x.
...
// returns bool of c being a valid hexadecimal
